...
""",
    ...
    pkg_archive(
        name = "mac_edge",
        url = "https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/71add213-82e6-47fc-868d-49c2d1c6fb8f/MicrosoftEdge-125.0.2535.79.pkg",
        sha256 = "085a6e415f808549ab67670b1b77d7f0bc6e0c501c469e032f341eaf21a13b99",
        move = {
            "MicrosoftEdge-125.0.2535.79.pkg/Payload/Microsoft Edge.app": "Edge.app",
        },
        build_file_content = """
load("@aspect_rules_js//js:defs.bzl", "js_library")
package(default_visibility = ["//visibility:public"])
